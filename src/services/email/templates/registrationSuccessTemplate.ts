/* ── registrationSuccessTemplate (Capitalise CGFX • mobile-friendly) ─────── */
...
<html lang="en">
  ...
  <body class="body">
    <div class="container">
      ...
      <div class="content">
        <h2 class="title">
          <span class="icon">🎉</span> Welcome to Capitalise CGFX!
        </h2>

        <p style="margin: 0 0 10px 0">Dear <strong>${name}</strong>,</p>
        <p style="margin: 0 0 12px 0">
          Welcome to <strong>Capitalise CGFX</strong> — your gateway to secure
